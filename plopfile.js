module.exports = (plop) => {
  ...
  plop.setGenerator("molecule", {
    ...
    actions: [
      ...
      },
      {
        ...
        // Path for the new file
        path:
          "src/molecules/{{pascalCase name}}/{{pascalCase name}}.module.scss",
        // Handlebars template used to generate content of new file
        templateFile: "plop-templates/Atomic.scss.hbs",
        // Add prefix in className
        data: { prefix: "m" },
  ...
  plop.setGenerator("organism", {
    ...
    actions: [
      ...
      },
      {
        ...
        // Path for the new file
        path:
          "src/organisms/{{pascalCase name}}/{{pascalCase name}}.module.scss",
        // Handlebars template used to generate content of new file
        templateFile: "plop-templates/Atomic.scss.hbs",
        // Add prefix in className
        data: { prefix: "o" },
  ...
  plop.setGenerator("template", {
    ...
    actions: [
      ...
      },
      {
        ...
        // Path for the new file
        path:
          "src/templates/{{pascalCase name}}/{{pascalCase name}}.module.scss",
        // Handlebars template used to generate content of new file
        templateFile: "plop-templates/Atomic.scss.hbs",
        // Add prefix in className
        data: { prefix: "t" },
  ...
  plop.setGenerator("page", {
    ...
    actions: [
      ...
      },
      {
        ...
        type: "add",
        // Path for the new file
        path: "tests/{{pascalCase name}}.test.js",
        // Handlebars template used to generate content of new file
        templateFile: "plop-templates/Atomic.test.js.hbs",
      },
    ],
  });
  ...
  //         name: "name",
  //         // Prompt to display on command line
  //         message: "What is your test file",
  //       },
  //     ],
  //     actions: [
  //       {
